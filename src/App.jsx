  ...
  return (
    <>
      ...
      <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 text-orange-500 bg-gray-700">
        <h1 className="text-center font-bold text-2xl my-5 text-white">Random Password Generator</h1>
        <div className='flex shadow gap-3 rounded-lg overflow-hidden mb-4'>
          <input
          type="text"
          value={password}
